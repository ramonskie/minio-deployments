...
minio BOSH deployments, using the format prescribed by the
...
To create a new environment (called us-east-prod-minio):
...
To download a new version of the kit, and deploy it:
    ...
    genesis download minio [version] # omitting version downloads the latest
...
- [minio-genesis-kit][2] - Details on the kit used in this repo,
...
[2]: https://github.com/genesis-community/minio-genesis-kit
